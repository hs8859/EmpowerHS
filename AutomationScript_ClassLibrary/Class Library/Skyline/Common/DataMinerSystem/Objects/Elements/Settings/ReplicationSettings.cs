namespace Skyline.DataMiner.Library.Common
{
	...
	internal class ReplicationSettings : ElementSettings, IReplicationSettings
	{
		...
		internal override void Load(ElementInfoEventMessage elementInfo)
		{
			...
			bool isEmpty = String.IsNullOrWhiteSpace(elementInfo.ReplicationRemoteElement) || elementInfo.ReplicationRemoteElement.Equals("/", StringComparison.Ordinal) || elementInfo.ReplicationRemoteElement.Equals(uint.MaxValue + "/" + uint.MaxValue, StringComparison.Ordinal);
