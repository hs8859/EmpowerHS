namespace Skyline.DataMiner.Library.Common.Rates
{
	...
	public class CounterWithDateTime<T> : RateCounter<T>
	{
		...
		private protected CounterWithDateTime(T counter, DateTime dateTime) : base(counter)
		{
			DateTime = dateTime;
		}
	...
	{
		internal Counter32WithDateTime(uint counter, DateTime dateTime) : base(counter, dateTime) { }
